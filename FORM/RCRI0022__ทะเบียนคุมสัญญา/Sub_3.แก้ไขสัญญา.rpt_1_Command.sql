...
|| ' ' || TO_VARCHAR(ADD_YEARS(T2."U_SLD_Edit_Date", 543), 'YY') AS "วันสิ้นสุดสัญญา(แก้ไข)" 
 ...
 ,TO_VARCHAR(T2."U_SLD_Extension_Date", 'D') || ' ' || 
MAP(MONTH(T2."U_SLD_Extension_Date"), 1,'ม.ค.', 2,'ก.พ.', 3,'มี.ค.', 4,'เม.ย.', 5,'พ.ค.', 6,'มิ.ย.', 7,'ก.ค.', 8,'ส.ค.', 9,'ก.ย.', 10,'ต.ค.', 11,'พ.ย.', 12,'ธ.ค.') 
|| ' ' || TO_VARCHAR(ADD_YEARS(T2."U_SLD_Extension_Date", 543), 'YY') AS "วันที่ขยายสัญญา"
