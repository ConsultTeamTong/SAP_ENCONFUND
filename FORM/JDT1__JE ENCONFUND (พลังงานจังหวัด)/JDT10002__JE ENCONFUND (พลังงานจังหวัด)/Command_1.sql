...
Path:   FORM\JDT1__JE ENCONFUND (พลังงานจังหวัด)\JDT10002__JE ENCONFUND (พลังงานจังหวัด).rpt
Extracted: 2026-07-01 09:28:08
-- Source: Main Report
-- Table:  Command_1
-- ============================================================
...
SELECT
    ...
    HA."descriptio" AS "ตำแหน่งยืนยัน",
     HEAD."U_SLD_CreateDate" AS "วันที่จัดทำ",
